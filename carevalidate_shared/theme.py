...
def sidebar_nav(current: str = ""):
    with st.sidebar:
        ...
        st.markdown(
            ...
            '<span style="font-size:10px;font-weight:600;color:#10b981;">HIPAA Safe Harbor</span>'
            '<span style="font-size:9px;color:#334155;margin-left:auto;">§164.514(b)</span></div>'
            '<div style="display:flex;align-items:center;gap:7px;padding:5px 8px;'
